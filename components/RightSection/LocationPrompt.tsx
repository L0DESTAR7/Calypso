    ...
    <div>
      <div className="w-96 h-10 z-[14] border-bunker-300/60 bg-bunker-100 border-[3px] rounded-full relative">
        <div className="flex flex-row w-full h-full px-4 place-items-start items-center gap-3">
          ...
          <input ref={inputRef} className="text-bunker-800 z-[15] font-extrabold text-lg capitalize bg-transparent w-72 outline-none" maxLength={90} onChange={e => delaySearch(e.target.value)} />
          <SuggestionHint />
